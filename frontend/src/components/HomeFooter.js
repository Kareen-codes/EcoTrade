        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-3">
              <img src={logo} alt="EcoMate AI" className="h-10 w-10 rounded-xl" />
              <span className="text-2xl font-bold text-white">
                EcoMate<span className="text-green-400"> AI</span>
              </span>
            </div>
            <p className="text-sm leading-relaxed text-gray-400">
              Transforming waste into value through AI-powered recycling. Join
              our community of changemakers building a sustainable future.
            </p>
